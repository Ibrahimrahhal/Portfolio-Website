...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="all">
      <div class="hero" style="background-color:#79c79c;">
        <div class="img" style="background-image:url('../assets/projects/ad.svg')"
  >

        </div>
      </div>
      <h2 class="proj-name">Arabian Developers Website</h2>
      <h4 class="techs">php - jquery - syntax highlighter - css - html</h4>
      ...
      <div class="btns">
        ...
        <a class="btn hvr-bounce-to-bottom gallery-btn" href="http://arabiandevs.com" target="_blank">
          View Live Copy
        </a>
      </div>
      <div class="desc">
