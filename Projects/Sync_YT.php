...
<html lang="en" dir="ltr">
  ...
  >
      ...
      <h2 class="proj-name">Synchronous Realtime Youtube Player</h2>
      <h4 class="techs">Node js - Express - Socket IO - Youtube Player API - html - Css</h4>
      ...
      <div class="btns">
        ...
        <a class="btn hvr-bounce-to-bottom gallery-btn" href="">
          View Live Copy
        </a>
      </div>
      <div class="desc">
